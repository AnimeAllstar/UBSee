    ...
    <Tab title="README" id="readme-tab" color="text-primary">
      <ListGroup>
        ...
        <ListGroup.Item>
          ...
          <p>
            The lines between courses represent the prerequisites between courses. <i>Hover </i> over a course for detailed prerequisite information.
          </p>
          <p>
          ...
          <p className="mb-1">
            <i> Ctrl + z </i> is undo and <i> Ctrl + y </i> is redo. This means that you can de-select nodes if you accidentally click something. The
            graph has to be selected (click anywhere on the graph background to select it).
          </p>
        </ListGroup.Item>
      </ListGroup>
    </Tab>
