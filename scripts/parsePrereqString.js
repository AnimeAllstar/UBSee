  ...
  sentences.forEach((sentence) => {
    ...
    matches.every((match) => {
      ...
      if (match.toString().toLowerCase() === 'either') {
        ...
        let variants = /\(a\)|\(b\)|\(c\)|or|and|one of|two of|all of|at least|strongly recommended/gi;
...
const testString3 =
  'Either (a) PSYC 100 or (b) two of PSYC 101, PSYC 102, PSYC 205, PSYC 207, PSYC 208, PSYC 216, PSYC 217, PSYC 277. Strongly recommended: PSYC 102 and either PSYC 216 or one of PSYC 217 or 277.';
